...
from trl import SFTTrainer, DPOTrainer, PPOTrainer, PPOConfig, DPOConfig

# ---------------- Step 1: Define Checkpoint Paths ----------------
# Training checkpoint directory (MooseFS storage, auto-deletes in a week)
checkpoint_dir = f"/mfs1/u/elizabeth/IMO-Comb-Solver-Models"
...
tokenizer = AutoTokenizer.from_pretrained(model_name, cache_dir=checkpoint_dir)
