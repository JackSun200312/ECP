...
from prover.prover.utils import AttrDict, MODEL_FORMAT
...
class GeneratorProcess(mp.Process):
    ...
    def run(self):
        ...
        try:
            ...
            llm = LLM(model=self.model_path, max_num_batched_tokens=8192, seed=seed, trust_remote_code=True, dtype = 'half')
        while True:
